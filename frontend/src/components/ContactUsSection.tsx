...
const ContactUsSection = ({ showBackButton = false, showFullHeader = true }: ContactUsSectionProps) => {
  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['Maka Al-Mukarrama Road', 'Mogadishu, Somalia'],
      links: null,
    },
    {
      icon: Phone,
      ...
      links: ['tel:+252612345678', 'tel:+252639876543'],
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['info@faithstate.so', 'sales@faithstate.so'],
      links: ['mailto:info@faithstate.so', 'mailto:sales@faithstate.so'],
    },
    {
      icon: Clock,
      title: 'Working Hours',
  ...
  return (
    <section id="contact-us" className="section-padding bg-muted/30 scroll-mt-24">
